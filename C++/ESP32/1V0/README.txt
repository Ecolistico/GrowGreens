...
* Falta crear mayor número de funciones que sirvan mediante la llegada de mensajes MQTT, como por ejemplo:
	1. Una función que permita modificar el parametro alfa del filtro exponencial.
	2. Una función que permita modificar la longitud del ID del contenedor para posteriores reconfiguraciones.
	3. Una función que permita modificar el parámetro del tiempo entre mediciones.
