...
String saveParams(AutoConnectAux& aux, PageArgument& args) {
  ...
  if (addr.fromString(mqttBrokerIp) && esp32Type=="germination" && testContID && esp32Floor.toInt()<10) {
    // The entered value is owned by AutoConnectAux of /mqtt_setting.
    // To retrieve the elements of /mqtt_setting, it is necessary to get
    // the AutoConnectAux object of /mqtt_setting.
  ...
  if(esp32Type=="germination"){
    echo.value += "ESP32 Type: " + esp32Type + "<br>";
  }else{
    echo.value += "ESP32 Type: <p style='color:red;'>It has to be 'germination'</p><br>";
  }
