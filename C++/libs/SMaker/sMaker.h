...
#define MAX_STEPPERS 5 // Max number of stepper motors
...
#define CarMotor 0
#define DispenserMotor 3
#define CargoMotor 1
#define ReleaseMotor 2
#define ExtraMotor 4
...
#define RELAY_ACTION_TIME 30000 // 30 seconds by default
#define DHTTYPE DHT22 //Define DHT22 type sensor
#define LIMIT_SWITCHES 5 //Define limit switch ammount
#define carHomeLS 0 //LS 1 normally closed
#define dispenserLS 3 //LS 4 normally open
#define carEndLS 4 //LS 5 normally closed
#define cargoLS 1 //LS 2 normally closed
#define openLS 2 //LS 3 normally closed
#define EZO_PH_OFF 12 //Define ezo off pin
#define EZO_EC_OFF 13 //Define ezo off pin
#define SOLUTIONS 10 //Define amount of 8salts+2acids to be used
#define RELAY_NUMBER 4 //Relay quantity
#define MIXER_RELAY 1 //defines mixer relay number, since only 1 relay is planned
// to be used, mixer can be set in any relay by changing the number
...
class sMaker
  {
    private:
        uint8_t        __DirS[MAX_STEPPERS], __StepS[MAX_STEPPERS], __mS[MAX_STEPPERS*2]; // Pins required for all the motors, dir, step and microsteps
        ...
        uint8_t        __Calibration[MAX_PUMPS_NUMBER]; // Calibration parameter for pumps
        ...
        uint8_t        __PumpVelocity; // pwm value for pumps
