...
#define MAX_SOLUTIONS_NUMBER 4 // Max number of stepper motors
#define MAX_PUMPS_NUMBER 2 // The max number of peristaltic pumps
#define MOTOR_SPEED 1000 // Maximum Steps Per Second
#define MOTOR_ACCEL 250 // Steps/second/Second of acceleration
#define DEFAULT_MICROSTEP 4 // By default we use configuration of 1/4 microSteps
...
class solutionMaker
  {
    private:
        uint8_t        __DirS[MAX_SOLUTIONS_NUMBER], __StepS[MAX_SOLUTIONS_NUMBER], __mS[MAX_SOLUTIONS_NUMBER*2]; // Pins required for all the motors
    ...
    public:
        ...
        bool dispense(); // Move some stepper to dispense some_mg
