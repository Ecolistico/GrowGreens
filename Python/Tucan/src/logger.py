...
class logger:
    def __init__(self):
        ...
        self.logger = logging.getLogger('Tucan')
        self.logger.setLevel(logging.INFO)
        
        # Create a file handler for each logger
        handler = logging.handlers.RotatingFileHandler('./temp/Tucan.log', maxBytes = 5*1024*1024, backupCount = 3)
