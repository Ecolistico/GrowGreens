...
from blue_server import BlueServer
...
with open("config.json") as f: data = json.load(f)
  ...
  # From blue_server
blue = BlueServer(data['dataServer']['MAC'], log.logger)
...
try:
    while run:
        ...
        # blue.available() # This is a blocking call, just activate it when expecting a connection
