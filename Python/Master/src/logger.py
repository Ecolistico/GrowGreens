...
class logger:
    def __init__(self):
        ...
        handler_esp32front1 = logging.handlers.RotatingFileHandler('./temp/esp32front1.log', maxBytes = 5000000, backupCount = 3)
        handler_esp32front1.setLevel(logging.DEBUG)
        handler_esp32center1 = logging.handlers.RotatingFileHandler('./temp/esp32center1.log', maxBytes = 5000000, backupCount = 3)
        handler_esp32center1.setLevel(logging.DEBUG)
        handler_esp32back1 = logging.handlers.RotatingFileHandler('./temp/esp32back1.log', maxBytes = 5000000, backupCount = 3)
        handler_esp32back1.setLevel(logging.DEBUG)
        handler_esp32front2 = logging.handlers.RotatingFileHandler('./temp/esp32front2.log', maxBytes = 5000000, backupCount = 3)
        handler_esp32front2.setLevel(logging.DEBUG)
        handler_esp32center2 = logging.handlers.RotatingFileHandler('./temp/esp32center2.log', maxBytes = 5000000, backupCount = 3)
        handler_esp32center2.setLevel(logging.DEBUG)
        handler_esp32back2 = logging.handlers.RotatingFileHandler('./temp/esp32back2.log', maxBytes = 5000000, backupCount = 3)
        ...
        handler_motorsGrower1 = logging.handlers.RotatingFileHandler('./temp/motorsGrower1.log', maxBytes = 5000000, backupCount = 3)
