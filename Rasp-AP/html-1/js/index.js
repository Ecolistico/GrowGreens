function download_csv() {
    var csv = 'state,city,floor,SSID,password,mqtt_ip\n';
    var fl;
...
function saveData(){
  ...
  $.get("php/data.php?state="+state+"&city="+city+"&floor="+floor+"&ssid="+ssid+"&password="+password+"&mqttIP="+mqttIP, function(data){
        alert(data);
        });
...
$(document).ready(function(){
  ...
  $(".form-wrapper .button").click(function(){
    ...
    if(currentSectionIndex === 1){
        if(document.getElementById("estado").value == "" || document.getElementById("municipio").value == ""){
            control = 1;
            document.getElementById("warn1").innerHTML = "Seleccione Estado/Municipio";
        }
        else if(+document.getElementById("num").value < 1 || +document.getElementById("num").value > 999){
            control = 1;
            document.getElementById("warn1").innerHTML = "Seleccione un consecutivo dentro del rango 1-999";
        }
    }
